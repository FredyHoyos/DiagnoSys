...
const index = ({formsCount=0, categoriesCount=0, itemsCount=0}) => {
  return (
    <div className='flex flex-wrap justify-around gap-4'> 
        <div className='flex flex-row space-x-3 rounded-lg border border-gray-300 p-4 shadow-sm w-48 items-center hover:shadow-lg hover:scale-105 transition-transform duration-200'>
