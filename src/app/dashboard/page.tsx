    ...
    <main className="min-h-screen py-12 px-6 sm:px-12 lg:px-24">
      <section className="max-w-5xl mx-auto">
        <header className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
          <div>
            <h1 className="text-2xl sm:text-3xl font-semibold text-primary">Plataforma de Diagnóstico Estratégico para la Transformación Digital</h1>
            <p className="text-lg text-black mt-8">DiagnoSys: comprende, evalúa y proyecta la transformación digital de tu organización con una herramienta guiada, flexible y estratégica.</p>
          </div>
        </header>
          ...
          {steps.map((s) => (
            ...
            >
              <div className="flex items-start gap-4 flex-1">
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between">
                    <p className="text-sm font-medium text-primary uppercase">Paso {s.id}</p>
              ...
              <div className="mt-6 flex items-center justify-between">
                <div className="text-base text-gray-800">Duración estimada: <strong>~3–10 min</strong></div>
              </div>
            </article>
          ))}
        </div>
        ...
        <section className="mt-10 border border-gray-100 rounded-2xl p-6 green-interactive">
          <h4 className="text-lg font-semibold text-primary">Usuarios Objetivo</h4>
          ...
          <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="p-4 rounded-lg border border-primary green-interactive">
              <p className="text-base font-medium text-primary">Empresas</p>
              <p className="text-sm text-gray-700 mt-1">Diagnósticos estratégicos para planificación de transformación.</p>
            </div>
            <div className="p-4 rounded-lg border border-primary green-interactive">
              <p className="text-base font-medium text-primary">Estudiantes</p>
              <p className="text-sm text-gray-700 mt-1">Herramienta práctica para aprendizaje y proyectos académicos.</p>
            </div>
            <div className="p-4 rounded-lg border border-primary green-interactive">
              <p className="text-base font-medium text-primary">Consultores</p>
              <p className="text-sm text-gray-700 mt-1">Herramienta estructurada para trabajo con clientes y evaluaciones.</p>
            </div>
          </div>
        </section>

        <footer className="mt-12 text-base text-gray-600 border-t pt-6">
          <p><strong>Contacto:</strong> <a href="mailto:proyectogestionti@gmail.com" className=" font-semibold text-blue-500 hover:underline">proyectogestionti@gmail.com</a></p>
          <p className="mt-2 text-gray-700"><strong>Créditos:</strong> Jhon Fredy Hoyos Cárdenas, Daniel Ramírez Cárdenas, Hellen Jakeline Rubio</p>
          <p className="mt-2 text-gray-700 italic">Este proyecto se desarrolla como parte de la iniciativa de investigación <strong>&ldquo;Marco de Gobernanza de Datos para Universidades.&rdquo;</strong> IP: Gina Maestre.</p>
        </footer>
      </section>
    </main>
  );
