...
export default function ForgotPasswordForm({ onSwitch }: Props) {
    ...
    async function onSubmit(data: ForgotPasswordForm) {
        ...
        try {
            ...
            if (res.ok) setMessage("If this email exists, we sent you reset instructions ✉️");
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className={styles.form}>
            ...
            <p className={styles.footer}>
                Remembered?{" "}
                <button type="button" onClick={onSwitch} className={styles.link}>Back to login</button>
            </p>
        </form>
    );
}
