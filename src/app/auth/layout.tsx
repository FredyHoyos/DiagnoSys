export default function AuthLayout({
    ...
    return (
        <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
            {/* Main container para despues arriba en el classname bg-gradient-to-br  from-emerald-50 via-teal-50 to-cyan-50*/}
                ...
                <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
                    ...
                    <div className="space-y-8 text-center lg:text-left">
                        ...
                        <div className="space-y-6">
                            <p className="text-base lg:text-lg text-emerald-800 leading-relaxed max-w-2xl">
                            ...
                            <p className="text-sm lg:text-base text-teal-700 leading-relaxed max-w-2xl">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-start gap-4 text-left">
                                ...
                                <p className="text-sm lg:text-base text-emerald-700 leading-relaxed">
                            ...
                            <div className="flex items-start gap-4 text-left">
                                ...
                                <p className="text-sm lg:text-base text-teal-700 leading-relaxed">
                            ...
                            <div className="flex items-start gap-4 text-left">
                                ...
                                <p className="text-sm lg:text-base text-cyan-700 leading-relaxed">
                    ...
                    {/* Authentication form container - Right side */}
